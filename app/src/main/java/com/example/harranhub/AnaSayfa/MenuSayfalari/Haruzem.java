 ...
 * Use the {@link Haruzem#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Haruzem extends Fragment {
     ...
     * @return A new instance of fragment Haruzem.
     */
    // TODO: Rename and change types and number of parameters
    public static Haruzem newInstance(String param1, String param2) {
        Haruzem fragment = new Haruzem();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        htmlSayfasi.loadUrl(getResources().getString(R.string.url_haruzem));
    ...
    private void htmlOzellikAyarla()
    {
        ...
        htmlSayfasi.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
                ...
                if(intent.resolveActivity(rootView.getContext().getPackageManager()) != null) //getactivity dene olmazsa
                {
    ...
    {
        Toast.makeText(rootView.getContext(), mesaj, Toast.LENGTH_SHORT).show();
    }
}